...
<ul id="navigator">
	...
	<a href="usual.php"><li>Повседневные товары</a><br><br>
		<ul>
			...
			<a href="devices.php"><li>Бытовая технкиа</li></a><br>
		</ul>
	</li>
</ul><br>
</div>
...
<div class="col2">
<h1 style="text-align: center; color:#cc1616">Все товары категории "Ядерная физика"</h1>
<?php 
	...
	$query = "SELECT * FROM products WHERE Number>0 AND Category='Ядерная физика' AND NOT EXISTS (SELECT * FROM bin WHERE bin.Login='$login' AND products.Prod_id = bin.Prod_id) ORDER BY products.Product" or die("Ошибка при выполнении запроса.." . mysqli_error($link));
