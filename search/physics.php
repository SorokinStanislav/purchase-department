...
<div class="col2">
<h1 style="text-align: center; color:#cc1616">Все товары категории "Физика"</h1>
<?php 
	...
	$query = "SELECT DISTINCT * FROM products WHERE Number>0 AND (Category='Mеханика' OR Category='Термодинамика' OR Category='Электричество' OR Category='Оптика' OR Category='Ядерная физика')
			  AND NOT EXISTS (SELECT * FROM bin WHERE bin.Login='$login' AND products.Prod_id = bin.Prod_id) ORDER BY products.Product" or die("Ошибка при выполнении запроса.." . mysqli_error($link));
