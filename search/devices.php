...
<div class="col2">
<h1 style="text-align: center; color:#cc1616">Все товары категории "Бытовая техника"</h1>
<?php
	...
	$query = "SELECT * FROM products WHERE Number>0 AND Category='Бытовая техника' AND NOT EXISTS (SELECT * FROM bin WHERE bin.Login='$login' AND products.Prod_id = bin.Prod_id) ORDER BY products.Product" or die("Ошибка при выполнении запроса.." . mysqli_error($link));
